...
console.log('task 1b:', createMenuItem('shrimp',12,'Lunch'));
console.log('task 1b:', createMenuItem('pickles',8,'Lunch'));
console.log('task 1b:', createMenuItem('pancakes',8,'Breakfast'));
